...
public class MainActivity extends Activity {
    ...
    private void compute(Calculator.Operator operator) {
        ...
        if (mOperandOneEditText.getText().toString().isEmpty()){
            mOperandOneEditText.setText("0");
        }
        if(mOperandTwoEditText.getText().toString().isEmpty()){
        ...
        try {
            ...
            mResultTextView.setText(getString(R.string.notEntered));
            return;
        }
    ...
    private static String getOperandText(EditText operandEditText) {
        if(operandEditText.toString().isEmpty()){
            operandEditText.setText("0.0");
        }
